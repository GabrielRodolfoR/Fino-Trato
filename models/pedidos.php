...
<body>
    ...
    <div class="container-fluid">
            ...
            <div class="col md-12">
                            ...
                            <div class="modal-body md-3 ">
                                <form class="form-group well" action="pedidos.php" method="POST" enctype="multipart/form-data">
                                    <div class="input-group mb-3">
                                        <input type="number" step="1" id="codUsuário" name="codUsuario" class="form-control" placeholder="Código Usuário" required>
                                    </div>
                                    <div class="input-group mb-3">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body md-3">
                                <form class="form-group well" action="pedidos.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="edit_codUsuario" name="codUsuario" class="form-control" placeholder="Codigo Usuário" required>
                                    </div>
                                    <div class="input-group mb-3">
                ...
                <table class="table table-hover table-bordered table-striped" bordercolor="gray" class="table table-striped">
                    ...
                    if (isset($_POST["cadastrar"])) {
                        ...
                        $sql = "INSERT INTO pedido (codUsuario, madeira, descricao, imagem, comprimento, largura, espessura) VALUES ('$codUsuario', '$madeira', '$descricao', '$destino', '$comprimento', '$largura', '$espessura')";
                    ...
                    if (isset($_POST["editar"])) {
                        ...
                        if (isset($_FILES['imagem']) && $_FILES['imagem']['error'] === UPLOAD_ERR_OK) {
                            ...
                            $sql = "UPDATE pedido SET codUsuario='$codUsuario', madeira='$madeira', descricao='$descricao', imagem='$destino', comprimento='$comprimento', largura='$largura', espessura='$espessura' WHERE codigo=$codigo";
                        } else {
                            // Mantém a imagem antiga se nenhuma nova foi enviada
                            $sql = "UPDATE pedido SET codUsuario='$codUsuario', madeira='$madeira', descricao='$descricao', comprimento='$comprimento', largura='$largura', espessura='$espessura' WHERE codigo=$codigo";
                        }
                    ...
                    while ($dados = mysqli_fetch_array($resultado)) {
                        ...
                        onclick=\"fillEditModal('{$dados['codigo']}', '{$dados['codUsuario']}', '{$dados['madeira']}', '{$dados['descricao']}', 
        ...
        <script>
            function fillEditModal(codigo, codUsuario, madeira, descricao, comprimento, largura, espessura) {
